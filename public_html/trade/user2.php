<?php
/* user2.php created for the user2
 * 
 * 
 */
 ...
 if($teams=$dClass-> getUserTeams(2))
 {
	 foreach($teams as $team)
	 {
		?>
		<div>
			<span> Team <?php echo $team['team_id'];?></span><a href="trade.php?teamid=<?php echo $team['id']; ?>&user_id=2"> Trade</a>
		</div>
		<?php
	 }
 }
 if($trades=$dClass-> getTradeRequests(2))
 {
